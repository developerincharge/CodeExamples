...
public class CheckEmpSalaryGreator {
    public static void main(String[] args) {
        ...
        boolean  isMatching = employees.stream()
                .anyMatch(emp -> emp.getSalary() > 5000);
        System.out.println("Are all employees salary greater than 70000 ? : " + isMatching
