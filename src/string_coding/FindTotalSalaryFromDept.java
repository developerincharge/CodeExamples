...
public class FindTotalSalaryFromDept {
    ...
    public static void main(String[] args) {
        ...
        double EmpTotalSalary = employees.stream()
                .filter(emp -> emp.getDepartment().equals("Finance"))
                .mapToDouble(Employee::getSalary)
                .sum();
        System.out.println("Total Salary of Department: " + EmpTotalSalary);

            double totalSum = ((Double) employees.stream()
                    .filter(emp -> emp.getDepartment().equals("Finance"))
                            .collect(Collectors.summingDouble(Employee::getSalary)));
        System.out.println("Total Salary of Department: " + totalSum);
